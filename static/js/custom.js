...
$(document).ready(function() {
    ...
    tinymce.init({
      ...
      mobile: {
        theme: 'mobile',
        plugins: ['autosave', 'lists', 'autolink', 'imagetools' ]
      },
      plugins: [
      ...
      toolbar: 'bold italic underline strikethrough | bullist numlist | alignleft aligncenter alignright alignjustify | link image',
    });
